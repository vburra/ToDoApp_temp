...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String sdttemp = intent.getStringExtra(dbEntry.COLUMN_NAME_PLANNED_START_TIME);
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date sdtDt = new Date();
        sdtDt.setTime(Long.parseLong(sdttemp));
//		try {
//			sdtDt = dateFormat.parse(sdttemp);
//		} catch (ParseException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
//        String sdt =sdtDt.toString();
	 ...
	 int requestID = (int) System.currentTimeMillis();
     		...
     		dismissIntent.putExtra(dbEntry.COLUMN_NAME_PLANNED_START_TIME,sdttemp);
     		...
     		PendingIntent piDismiss = PendingIntent.getBroadcast(context.getApplicationContext(), requestID, dismissIntent, PendingIntent.FLAG_UPDATE_CURRENT);
     		...
     		startIntent.putExtra(dbEntry.COLUMN_NAME_PLANNED_START_TIME, sdttemp);
     		...
     		PendingIntent piStart = PendingIntent.getBroadcast(context.getApplicationContext(), requestID, startIntent, PendingIntent.FLAG_UPDATE_CURRENT);
